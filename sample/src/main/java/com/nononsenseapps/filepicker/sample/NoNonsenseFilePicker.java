...
import com.nononsenseapps.filepicker.sample.googledrive.DriveFilePickerActivity;
...
public class NoNonsenseFilePicker extends Activity
{
    ...
    public static final int CODE_DRIVE = 2;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        final CheckBox checkAllowCreateDir = (CheckBox) findViewById(R.id.checkAllowCreateDir);
        final CheckBox checkAllowMultiple = (CheckBox) findViewById(R.id.checkAllowMultiple);
        final RadioGroup radioGroup = (RadioGroup) findViewById(R.id.radioGroup);
        textView = (TextView) findViewById(R.id.text);

        findViewById(R.id.button_sd).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(final View v)
            {
                ...
                i.putExtra(Extras.EXTRA_ALLOW_MULTIPLE, checkAllowMultiple.isChecked());
                i.putExtra(Extras.EXTRA_ALLOW_CREATE_DIR, checkAllowCreateDir.isChecked());
        ...
        findViewById(R.id.button_dropbox).setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(final View v)
            {
                ...
                {  // User is authorized, open file picker
                    Intent i = new Intent(NoNonsenseFilePicker.this, DropboxFilePickerActivity.class);
        ...
        findViewById(R.id.button_drive).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(final View v)
            {
                Intent i = new Intent(NoNonsenseFilePicker.this, DriveFilePickerActivity.class);
                ...
                startActivityForResult(i, CODE_DRIVE);
            }
        });
    }
    ...
    {
        if ((CODE_SD == requestCode || CODE_DB == requestCode || CODE_DRIVE == requestCode)
                && resultCode == Activity.RESULT_OK)
        {
            if (data.getBooleanExtra(Extras.EXTRA_ALLOW_MULTIPLE, false))
            {
                ...
                ArrayList<String> paths = data.getStringArrayListExtra(Extras.EXTRA_PATHS);
                StringBuilder sb = new StringBuilder();
